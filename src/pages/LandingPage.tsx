        ...
        <div className={styles.landingContainer}>
            ...
            <section className={styles.heroSection}>
                ...
                <p className={styles.heroSubtext}>
                    Lumen is an evidence-based Applicant Tracking System that answers questions
                    about candidates using only their real documents — with citations, no hallucinations.
                </p>
            ...
            <section className={styles.featuresSection}>
                <h2 className={styles.featuresTitle}>Why Hiring Teams Choose Lumen</h2>
                    ...
                    {Array(4).fill(0).map((_, i) => (
                        <div className={styles.featureCard} key={i}>
                            ...
                            <p className={styles.featureText}>
                                Ask “Do they have React experience?” get a cited answer from their
                                CV or interview notes.
                            </p>
                        </div>
                    ))}
                </div>
            ...
            <section className={styles.ctaSection}>
                ...
                <button className={styles.ctaBtn}>Get Started – Free Trial</button>
            </section>
